...
<div class="modal fade" id="kechengListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                专业
                                                <select name="zhuanyeTypesSelectSearch" style="width: 100px;" id="zhuanyeTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //查看班级中的课程
        var detailBtn = document.createElement('button');
        var detailAttr = "detailKecheng(" + item.id + ')';
        detailBtn.setAttribute("type", "button");
        detailBtn.setAttribute("class", "btn btn-info btn-sm 查看");
        detailBtn.setAttribute("onclick", detailAttr);
        detailBtn.innerHTML = "查看班级课程"
        btnGroup.appendChild(detailBtn)
        //修改按钮
    ...
    function detailKecheng(aid) {
        id=aid;
        debugger
        $('#kechengListModal').modal('show');

    }


    $('#kechengListModal').on('show.bs.modal', function () {
        debugger
        http("banjiKecheng/page", "GET", {
            page: 1,
            limit: 100,
            sort: sortColumn,
            order: sortOrder,
            ...
            for (var i = 0; i < list.length; i++) { //遍历一下表格数据  
                var trow = setKechengListDataRow(list[i]); //定义一个方法,返回tr数据 
                $('#kechengListTbody').append(trow);
            }
        }else{
            alert("查不到该班级中的课程详情");
        }
    ...
    $('#kechengListModal').on('hide.bs.modal', function () {
        $("#kechengListTbody").html("");
    })


    // 添加当前订单中物资到查看列表
    function setKechengListDataRow(item) {
        //创建行 
        var row = document.createElement('tr');
        //课程名称
        ...
        laoshiNameCell.innerHTML = item.name;
