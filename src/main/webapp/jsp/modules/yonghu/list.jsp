                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                是否领取过物品
                                                <select name="wupinTypesSelectSearch" style="width: 100px;" id="wupinTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
                                            ...
                                            <label>
                                                用户状态
                                                <select name="yonghuTypesSelectSearch" style="width: 100px;" id="yonghuTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
